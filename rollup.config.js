...
export default {
	...
	server: {
		...
		external: [
			...
			...Object.keys(require('express/package.json').dependencies),
			...Object.keys(require('apollo-server-express/package.json').dependencies),
			...Object.keys(require('type-graphql/package.json').dependencies),
			...Object.keys(require('express-session/package.json').dependencies),
			...Object.keys(require('secure-password/package.json').dependencies),
			'dotenv',
			'dotenv/config'
		 ],
