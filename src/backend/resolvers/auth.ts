import {
  ...
  import { AUTH_COOKIE_NAME, AUTH_COOKIE_VALUE, SESSION_NAME } from "../../config";
  ...
  export class AuthResolver {
    ...
    async login(
      ...
      res.cookie(AUTH_COOKIE_NAME, AUTH_COOKIE_VALUE(user.role), {httpOnly: false, signed: false, sameSite: 'strict'})
    ...
    async logout(@Ctx() { ctx: { res, req } }: Context) {
      ...
      res.cookie(AUTH_COOKIE_NAME, "0", { httpOnly: false, signed: false, sameSite: 'strict' })
      return true;
    }
